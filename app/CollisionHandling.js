    ...
    function handleAsteroids() {
        ...
        for (var i = 0; i <= asteroids.length - 2; i++) {
            ...
            for (var j = i+1; j <= asteroids.length - 1; j++) {
                if (intersectSphereOther(getAsteroidHitbox(asteroids[i]),
            ...
            for (var j = 0; j <= playerHitboxes.length; j++) {
                if (intersectSphereBox(getAsteroidHitbox(asteroids[i]),
                        playerHitboxes[j])) {
        ...
        for (var i = 0; i <= projectiles.length - 1; i++) {
            ...
            for (var j = 0; j <= asteroids.length - 1; j++) {
                ...
                if (projectiles[i].type === "Laser") {
                    if (intersectSphereCylinder(getAsteroidHitbox(asteroids[j]),
                            projectiles[i])) {
                ...
                else if (projectiles[i].type === "Rocket") {
                    if (intersectSphereCylinder(getAsteroidHitbox(asteroids[j]),
                            projectiles[i])) {
                ...
                else if (projectiles[i].type === "Explosion") {
                ...
                else if (projectiles[i].type === "MachineGun") {
                    if (intersectSphereOther(getAsteroidHitbox(asteroids[j]),
                            projectiles[i])) {
            ...
            //         else if (projectiles[i].type === "EnemyLaser") {
            //             if (intersectBoxCylinder(enemyHitboxes[k], projectiles[i])) {
            //                 successLaser(projectiles[i]);
            //                 enemyHitByLaser(enemies[j]);
            //             }
            ...
            //     if (projectiles[i].type === "Explosion") {
            //         if (intersectSphereOther(getAsteroidHitbox(asteroids[j]),
            //                 projectiles[i])) {
